...
int main() {
	...
	// TEXTURE
	Texture wall((parentDir + texPath + "container.jpg").c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGB, GL_UNSIGNED_BYTE);
	Texture face((parentDir + texPath + "awesomeface.png").c_str(), GL_TEXTURE_2D, GL_TEXTURE1, GL_RGBA, GL_UNSIGNED_BYTE);
