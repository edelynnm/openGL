...
bool isLeni = true; // change value to change color

// Define vertices in 3D format
GLfloat vertices[] =
{
	// positions			// colors				// texture coords
	0.5f, 0.5f, 0.0f,		1.0f, 0.0f, 0.70f,		1.0f, 1.0f, // top right 
	0.5f, -0.5f, 0.0f,		1.0f, 0.0f, 0.70f,		1.0f, 0.0f, // bottom right 
	-0.5f, -0.5f, 0.0f,		1.0f, 0.0f, 0.70f,		0.0f, 0.0f, // bottom left 
	-0.5f, 0.5f, 0.0f,		1.0f, 0.0f, 0.70f,		0.0f, 1.0f, // top left
};
...
int main() {
	...
	// TEXTURE
	Texture wall((parentDir + texPath + "psse-logo.jpg").c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGB, GL_UNSIGNED_BYTE, GL_REPEAT, GL_NEAREST);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shaderProgram.SetBool("isLeni", isLeni);
